...
import math
import builtins  # Never necessary, but here for pedagogical reasommma
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(2, 10, 0.29)
    ...
    # Test 4:
    expected = 3
    answer = count_cosines_from(4, 12, 0.29)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(5, 13, 0.29)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(6, 14, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    expected = .7595238095  # This is APPROXIMATELY the correct answer.
